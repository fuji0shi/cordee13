...
export const LandingLayout = ({ children }: LayoutProps) => {
  return (
    <BaseLayout>
      ...
      <main className="flex grow flex-col-reverse gap-4 px-2 py-2 md:grid md:grid-cols-[1fr_2fr] md:gap-12 md:px-6 md:py-6 lg:grid-cols-[4fr_4fr] lg:pt-6 xl:grid-cols-[6fr_6fr] xl:px-40 2xl:px-52 3xl:px-80">
        {children}
      </main>
