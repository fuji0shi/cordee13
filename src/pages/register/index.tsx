  ...
  return (
    <BaseLayout>
      <div className="container relative flex min-h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="absolute bottom-4 left-8 md:bottom-8 md:right-12">
          <ThemeToggle />
        </div>
        <div className="grid place-items-center md:h-full">
          <div className="flex flex-col gap-8">
            <div className="py-auto flex flex-col items-center gap-4">
              <div className="mb-6">
                <h1 className="text-3xl font-extrabold">
                  Création votre compte utilisateur
                </h1>
        ...
        <div className="relative hidden h-full flex-col p-10 lg:flex">
          <div className="absolute inset-0 flex min-h-screen items-center justify-center">
            <Image
              ...
              src="/images/landscape-moutains-sunset.webp"
              fill
              priority
              sizes="lg"
            />
            <div
              className="absolute bottom-0 right-0 cursor-pointer p-2 lg:flex lg:flex-col lg:p-5"
              onClick={() => router.push("/")}
            >
